...
class HOTP
  ...
  # this object.
  def initialize secret, digits: DEFAULT_DIGITS
  ...
  def at count, padding: true
    ...
    padding ? otp.rjust(@digits, '0') : otp
  end
  ...
  def verify input_token, at: 0, padding: true
    self.at(at, padding: padding).to_s.securecmp(input_token.to_s)
  end
